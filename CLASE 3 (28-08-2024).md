...
$\left(s+1\right)\left(\frac{s+3}{\left(s+1\right)\left(s+2\right)}\right)_{s=-1}=\left(s+1\right)\left(\frac{A}{\left(s+1\right)}\right)_{s=-1}+\left(s+1\right)\left(\frac{B}{\left(s+2\right)}\right)_{s=-1}$
