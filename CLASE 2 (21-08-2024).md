...
$$e\frac{1}{3}e^{-t}\sin \left(t\right)+\frac{e^{-t}\sin \left(2t\right)}{3}$$
...
$\frac{-\left(-4\right)\pm \sqrt{\left(-4\right)^2-4\left(13\right)}}{2}$
...
$\frac{2s+4}{s^2-4s+13}=\frac{A}{\left(s-2-3i\right)}+\frac{B}{\left(s-2+3i\right)}$

$2s+4=A\left(s-2+3i\right)+B\left(s-2-3i\right)$

$2s+4=As+A\left(-2+3i\right)+Bs+B\left(-2-3i\right)$
